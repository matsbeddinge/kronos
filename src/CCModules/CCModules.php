<?php
/**
 * To manage and analyse all modules of Kronos.
 *
 * @package KronosCore
 */
class CCModules extends CObject implements IController {
  ...
  public function Index() {
    ...
    $this->views->AddInclude(dirname(__FILE__) . '/index.tpl.php', array('controllers'=>$controllers), 'primary');
    $this->views->AddInclude(dirname(__FILE__) . '/sidebar.tpl.php', array('modules'=>$allModules), 'sidebar');
  }
  ...
  public function Install() {
    ...
    $this->views->AddInclude(dirname(__FILE__) . '/install.tpl.php', array('modules'=>$results), 'primary');
    $this->views->AddInclude(dirname(__FILE__) . '/sidebar.tpl.php', array('modules'=>$allModules), 'sidebar');
  }
  ...
  public function View($module) {
    ...
    $this->views->SetTitle('Manage Modules');
    $this->views->AddInclude(dirname(__FILE__) . '/view.tpl.php', array('module'=>$aModule), 'primary');
    $this->views->AddInclude(dirname(__FILE__) . '/sidebar.tpl.php', array('modules'=>$allModules), 'sidebar');
  }
