...
class CCMyController extends CObject implements IController {
  ...
  public function Index() {
    ...
    $this->views->AddInclude(dirname(__FILE__) . '/page.tpl.php', array(
			'content' => $content,
		));
  }
  ...
  public function Blog() {
    ...
    $this->views->AddInclude(dirname(__FILE__) . '/blog.tpl.php', array(
  ...
  public function Guestbook() {
    ...
    $this->views->AddInclude(dirname(__FILE__) . '/guestbook.tpl.php', array(
